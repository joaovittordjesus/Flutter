...
import 'package:desenvolvimento_aplicativo_autenticacao_configuracoes/Model.dart';
...
class DataBaseHelper {
  ...
  static const String CREATE_USERS_TABLE_SCRIPT =
      'CREATE TABLE users(id INTEGER PRIMARY KEY AUTOINCREMENT, username TEXT, password TEXT, email TEXT, theme TEXT)'; // Adicionando o campo 'theme' para armazenar as configurações personalizadas do usuário
